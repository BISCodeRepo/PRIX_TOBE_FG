...
public interface UserSettingMapper {
    ...
    @Select("SELECT user_id AS userId, enzyme, mmc, met, ptol, ptol_unit AS ptolUnit, ftol, mm_min AS mmMin, mm_max AS mmMax, engine, data_format AS dataFormat, instrument, ms_resolution AS msResolution, msms_resolution AS msmsResolution FROM px_user_setting WHERE user_id = #{id} AND engine = 'modeye'")
